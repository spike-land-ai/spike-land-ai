...
| TypeScript   | Strict mode enabled                             | Strict, zero `any`, zero `eslint-disable`              | Codex integrates with the TS Language Server; strict mode = level zero                                                     |
| AGENTS.md    | Current and complete                            | Updated Feb 16, 2026 (7 pkgs, 98 tools, ~170 routes)   | Stops the AI from guessing; it follows the playbook instead                                                                      |
