...
describe("PostHandler - Validation", () => {
  ...
  describe("validateMessages", () => {
    ...
    it("should validate parts array structure", () => {
      ...
      expect(callValidateMessages(messages)).toBe("Message at index 0 parts must be an array");
    });
    ...
    it("should validate parts have type field", () => {
      ...
      expect(callValidateMessages(messages)).toBe("Message at index 0, part 0 must have a type");
    });
    ...
    it("should validate array content parts", () => {
      const messages = [
        {
          role: "user",
          content: [{ type: "text", text: "Hello" }, "invalid part"],
        },
      ];
      expect(callValidateMessages(messages)).toBe(
