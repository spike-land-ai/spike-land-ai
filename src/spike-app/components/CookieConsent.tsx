...
export function CookieConsent() {
  ...
  return (
    ...
    >
      <div className="bg-card/95 border border-border shadow-[0_-8px_30px_rgb(0,0,0,0.12)] backdrop-blur-md rounded-2xl p-5 md:p-6 max-w-4xl mx-auto flex flex-col md:flex-row items-start md:items-center gap-6">
