...
const FAQ_ITEMS = [
  {
    ...
    answer:
      "The free plan gives you 50 AI credits per day, access to 10 MCP tools, a basic dashboard, and community support. It's a great way to explore the platform before committing to a paid plan.",
  },
  {
    question: "How do AI credits work?",
    answer:
      "AI credits are consumed each time you make a request to an AI-powered tool or chat endpoint. Credits reset daily at midnight UTC. Unused credits do not roll over.",
  },
  {
