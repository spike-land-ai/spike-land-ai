import { EditorCommandPalette } from "../ui/@/components/app/monaco/editor-command-palette";
...
import { useErrorEffect } from "../ui/hooks/useErrorEffect";
import { errorMessages } from "../core-logic/components/ErrorMessages";
...
export const EditorNode: React.FC<{
  ...
  return (
    <div className="w-full h-full flex flex-col">
      <ErrorReminder errorType={errorType} onHeightChange={setErrorHeight} codeSpace={codeSpace} />
      <motion.div
