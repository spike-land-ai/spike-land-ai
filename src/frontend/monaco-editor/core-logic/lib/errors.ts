...
export function createError(code: ErrorCode, message: string, details?: unknown): AppError {
  switch (code) {
    case ErrorCode.WEBSOCKET_ERROR:
      return new WebSocketError(message, details instanceof Error ? details : undefined);
    case ErrorCode.DOM_ERROR:
      return new DOMError(message, typeof details === "string" ? details : undefined);
    case ErrorCode.ROUTER_ERROR:
      return new RouterError(message, typeof details === "string" ? details : undefined);
    ...
    case ErrorCode.CACHE_ERROR:
      return new CacheError(message, typeof details === "string" ? details : undefined);
    case ErrorCode.VALIDATION_ERROR:
      return new ValidationError(message, typeof details === "string" ? details : undefined);
    default:
