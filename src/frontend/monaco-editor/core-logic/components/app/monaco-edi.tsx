import { ata } from "../../../concurrency/shared";
import { startMonaco } from "./monaco/monaco-index.ts";
import type { EditorConfig, EditorModel } from "../../../editor/types";
...
export const startMonacoEditor = async ({
  ...
  mod[codeSpace] = await startMonaco({ code, container, codeSpace, onChange }, ata);
