...
describe("importMapReplace", () => {
  const scenarios = {
    ...
    "Path imports": {
      ...
      "should preserve existing extensions in relative imports": `import { component } from "./components/Button";`,
    ...
    "Dynamic imports": {
      ...
      "dynamic imports with string concatenation": `const mod = await import('./modules/' + name + '/index');`,
    },
