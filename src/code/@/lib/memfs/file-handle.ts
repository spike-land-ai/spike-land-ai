...
class FileHandleImpl implements FileHandle {
  ...
  async utimes(_atime: string | number | Date, _mtime: string | number | Date): Promise<void> {
    throw new Error("Method not implemented");
  }
 ...
 */
export const createFileHandle = (fileHandle: FileSystemFileHandle, _path: string): FileHandle => {
