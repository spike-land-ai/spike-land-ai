...
class SessionPatcher {
  ...
  public static applySessionDelta(sess: ICodeSession, sessionDelta: SessionDelta): ICodeSession {
    ...
    if (newHash !== sessionDelta.hashCode) {
      throw new Error(
        "New hash does not match:" +
          newHash +
          " !== " +
          sessionDelta.hashCode +
          "\n" +
  ...
  public static generateSessionPatch(oldSess: ICodeSession, newSess: ICodeSession): SessionDelta {
