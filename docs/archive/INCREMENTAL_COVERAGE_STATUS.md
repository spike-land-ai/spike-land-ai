...
- [ ] src/spike-land-mcp/app.ts (via .tests/spike-land-mcp/app.test.ts)
...
- [ ] src/mcp-auth/index.ts (via .tests/mcp-auth/index.test.ts)
- [ ] src/mcp-auth/auth.ts (via .tests/mcp-auth/auth.test.ts)
...
- [ ] src/chess-engine/elo.ts (via .tests/chess-engine/elo.test.ts)
...
- [ ] src/shared/utils/index.ts (via .tests/shared/utils/index.test.ts)
- [ ] src/shared/validations/index.ts (via .tests/shared/validations/index.test.ts)
- [ ] src/shared/types/social-api-guards.ts (via .tests/shared/types/social-api-guards.test.ts)
...
- [ ] src/qa-studio/tools.ts: 99.34% (via .tests/qa-studio/tools.test.ts)
- [ ] src/state-machine/parser.ts: 99.32% (via .tests/state-machine/parser.test.ts, .tests/state-machine/parser.coverage.test.ts)
- [ ] src/bazdmeg-mcp/tools/deps.ts: 98.96% (via .tests/bazdmeg-mcp/tools/deps.test.ts)
- [ ] src/bazdmeg-mcp/context-bundle.ts: 98.52% (via .tests/bazdmeg-mcp/context-bundle.test.ts)
- [ ] src/mcp-image-studio/tools/generate.ts: 98.38% (via .tests/mcp-image-studio/tools/generate.test.ts)
- [ ] src/spike-review/worker/webhook-handler.ts: 97.67% (via .tests/spike-review/worker/webhook-handler.test.ts)
- [ ] src/mcp-image-studio/tools/banner.ts: 97.36% (via .tests/mcp-image-studio/tools/banner.test.ts)
- [ ] src/spike-land-backend/largeValueStorage.ts: 97.22% (via .tests/spike-land-backend/largeValueStorage.test.ts)
- [ ] src/spike-review/rules/engine.ts: 97.05% (via .tests/spike-review/rules/engine.test.ts)
- [ ] src/bazdmeg-mcp/tools/manifest.ts: 97% (via .tests/bazdmeg-mcp/tools/manifest.test.ts)
- [ ] src/mcp-image-studio/tools/album-images.ts: 96.96% (via .tests/mcp-image-studio/tools/album-images.test.ts)
- [ ] src/spike-land-mcp/auth/jwt.ts: 96.87% (via .tests/spike-land-mcp/auth/jwt.test.ts)
- [ ] src/openclaw-mcp/bridge.ts: 96.82% (via .tests/openclaw-mcp/bridge.test.ts)
- [ ] src/bazdmeg-mcp/tools/workflow.ts: 96.47% (via .tests/bazdmeg-mcp/tools/workflow.test.ts)
- [ ] src/bazdmeg-mcp/workspace-resolver.ts: 96.15% (via .tests/bazdmeg-mcp/workspace-resolver.test.ts)
- [ ] src/mcp-image-studio/tools/diagram.ts: 96.15% (via .tests/mcp-image-studio/tools/diagram.test.ts)
- [ ] src/bazdmeg-mcp/manifest.ts: 95.96% (via .tests/bazdmeg-mcp/manifest.test.ts)
- [ ] src/bazdmeg-mcp/gates/engine.ts: 95.6% (via .tests/bazdmeg-mcp/gates/engine.test.ts)
- [ ] src/qa-studio/narrate.ts: 95.34% (via .tests/qa-studio/narrate.test.ts)
- [ ] src/spike-land-mcp/kv/rate-limit.ts: 95% (via .tests/spike-land-mcp/kv/rate-limit.test.ts)
- [ ] src/spike-land-mcp/mcp/schema-optimizer.ts: 94.73% (via .tests/spike-land-mcp/mcp/schema-optimizer.test.ts)
- [ ] src/spike-cli/commands/common.ts: 94.59% (via .tests/spike-cli/commands/common.test.ts)
- [ ] src/spike-land-mcp/routes/oauth.ts: 94.28% (via .tests/spike-land-mcp/routes/oauth.test.ts)
- [ ] src/spike-land-mcp/tools/tool-helpers.ts: 93.57% (via .tests/spike-land-mcp/tools/tool-helpers.test.ts)
- [ ] src/spike-land-mcp/mcp/manifest.ts: 91.78% (via .tests/spike-land-mcp/mcp/manifest.test.ts)
- [ ] src/openclaw-mcp/cli.ts: 91.42% (via .tests/openclaw-mcp/cli.test.ts)
- [ ] src/state-machine/engine.ts: 91.09% (via .tests/state-machine/engine.test.ts, .tests/state-machine/engine.coverage.test.ts)
- [ ] src/qa-studio/browser-session.ts: 90.58% (via .tests/qa-studio/browser-session.test.ts)
...
- [ ] src/spike-land-mcp/auth/middleware.ts: 87.5% (via .tests/spike-land-mcp/auth/middleware.test.ts)
...
- [ ] src/spike-land-mcp/routes/mcp.ts: 82.22% (via .tests/spike-land-mcp/routes/mcp.test.ts)
- [ ] src/spike-cli/cli.ts: 81.81% (via .tests/spike-cli/cli.test.ts)
- [ ] src/spike-app/hooks/useAnalytics.ts: 79.66% (via .tests/spike-app/hooks/useAnalytics.test.ts)
- [ ] src/image-studio-worker/deps/generation.ts: 79.1% (via .tests/image-studio-worker/deps/generation.test.ts)
- [ ] src/mcp-image-studio/register.ts: 78.37% (via .tests/mcp-image-studio/register.test.ts)
- [ ] src/incremental-test-mcp/logic.ts: 76.31% (via .tests/incremental-test-mcp/logic.test.ts)
- [ ] src/spike-land-mcp/auth/oauth-device.ts: 74.41% (via .tests/spike-land-mcp/auth/oauth-device.test.ts)
- [ ] src/spike-land-mcp/mcp/registry.ts: 68.31% (via .tests/spike-land-mcp/mcp/registry.test.ts)
- [ ] src/spike-land-backend/chatRoom.ts: 62.75% (via .tests/spike-land-backend/chatRoom.test.ts)
- [ ] src/spike-cli/config/types.ts: 33.33% (via .tests/spike-cli/config/types.test.ts)
- [ ] src/spike-review/index.ts: 18.96% (via .tests/spike-review/index.test.ts)
