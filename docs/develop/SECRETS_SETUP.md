...
3. Create bucket (e.g., `spike-land-images` for images, `spike-land-backups` for
   database backups)
4. Go to "Manage R2 API Tokens" > Create API Token
5. Configure token:
   - **Permissions**: Read & Write (required for uploads and deletion during
     backup rotation)
