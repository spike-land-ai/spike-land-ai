...
| Directory              | Package                           | Runtime     | Purpose                                                        |
| ---------------------- | --------------------------------- | ----------- | -------------------------------------------------------------- |
| `src/spike-cli`        | `@spike-land-ai/spike-cli`        | Node.js CLI | MCP multiplexer CLI with Codex chat integration               |
...
streaming). See `src/react-ts-worker/AGENTS.md` for architecture details.
