...
export function registerCreativeTools(
  ...
  registry.register({
    ...
    description:
      "Create a creative set with variants from original content. Variants are created with PENDING status for async generation.",
    category: "creative",
    tier: "free",
    inputSchema: GenerateVariantsSchema.shape,
    handler: async (
      args: z.infer<typeof GenerateVariantsSchema>,
  ...
  registry.register({
    ...
    description:
      "Detect creative fatigue alerts for a workspace. Returns unresolved fatigue alerts ordered by detection time.",
    category: "creative",
    tier: "free",
    inputSchema: DetectFatigueSchema.shape,
    annotations: { readOnlyHint: true },
    handler: async (
      args: z.infer<typeof DetectFatigueSchema>,
    ): Promise<CallToolResult> =>
  ...
  registry.register({
    ...
    description:
      "Get performance metrics for a creative set and its variants, including impressions, clicks, CTR, and conversions.",
    category: "creative",
    tier: "free",
    inputSchema: GetPerformanceSchema.shape,
    annotations: { readOnlyHint: true },
    handler: async (
      args: z.infer<typeof GetPerformanceSchema>,
    ): Promise<CallToolResult> =>
  ...
  registry.register({
    ...
    annotations: { readOnlyHint: true },
    handler: async (
      args: z.infer<typeof ListSetsSchema>,
    ): Promise<CallToolResult> =>
