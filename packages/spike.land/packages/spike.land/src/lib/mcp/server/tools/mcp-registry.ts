...
export function registerMcpRegistryTools(
  ...
  registry.register({
    ...
    handler: async (
      { query, limit = 10 }: z.infer<typeof McpRegistrySearchSchema>,
  ...
  registry.register({
    ...
    handler: async (
      { serverId, source }: z.infer<typeof McpRegistryGetSchema>,
    ): Promise<CallToolResult> =>
  ...
  registry.register({
    ...
    handler: async (
      { serverId, source, envVars }: z.infer<typeof McpRegistryInstallSchema>,
    ): Promise<CallToolResult> =>
