...
export function registerCreateTools(
  ...
  registry.register({
    ...
    description: "Search published /create apps by title, description, or slug. "
  ...
  registry.register({
    name: "create_get_app",
    description: "Get full details for a specific /create app by its slug, "
  ...
  registry.register({
    ...
    description: "Classify an app idea into a URL slug and category using AI. "
  ...
  registry.register({
    ...
    description: "Check if a codespace is healthy (has real, non-default content). "
      + "Returns true/false.",
    category: "create",
    tier: "free",
  ...
  registry.register({
    ...
    description: "List the most popular published /create apps by view count. "
  ...
  registry.register({
    ...
    description: "List the most recently generated published /create apps. "
      + "Only healthy codespaces are included.",
    category: "create",
    tier: "free",
    inputSchema: ListAppsSchema.shape,
  ...
  registry.register({
    ...
    description: "Quick status check for a /create app. "
