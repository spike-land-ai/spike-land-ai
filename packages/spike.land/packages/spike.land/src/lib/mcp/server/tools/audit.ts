...
export function registerAuditTools(
  ...
  registry.register({
    ...
    handler: async (
      args: z.infer<typeof AuditQueryLogsSchema>,
      ...
      safeToolCall("audit_query_logs", async () => {
        ...
        const lines = logs.map(log =>
          `- [${log.createdAt.toISOString()}] **${log.action}** on ${
  ...
  registry.register({
    ...
    handler: async (
      args: z.infer<typeof AuditExportSchema>,
    ): Promise<CallToolResult> =>
  ...
  registry.register({
    ...
    handler: async (
      args: z.infer<typeof AuditGetAIDecisionsSchema>,
    ): Promise<CallToolResult> =>
      safeToolCall("audit_get_ai_decisions", async () => {
        ...
        const lines = decisions.map(d =>
          `- [${d.createdAt.toISOString()}] **${d.requestType}** — input: ${
            d.inputPrompt ?? "n/a"
  ...
  registry.register({
    ...
    handler: async (
      args: z.infer<typeof AuditGetAgentTrailSchema>,
    ): Promise<CallToolResult> =>
