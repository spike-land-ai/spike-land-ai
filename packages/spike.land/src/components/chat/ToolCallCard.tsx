      ...
      >
        ...
        <CollapsibleTrigger asChild>
          ...
          >
            ...
            <span className="font-medium text-zinc-200 truncate">{formatToolName(block.name)}</span>
            <Badge
              variant="outline"
        ...
        <CollapsibleContent>
          <div className="border-t border-white/10 px-3 py-2 space-y-2">
            ...
            {Object.keys(block.input).length > 0 && (
              <div>
                <p className="text-[10px] uppercase tracking-wider text-zinc-500 mb-1">Input</p>
