...
export function Leaderboard() {
  ...
  useEffect(() => {
    fetch("/api/connect/leaderboard?limit=50")
      ...
      .catch((err) => console.error("[Leaderboard] Failed to load data:", err))
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <p className="text-zinc-400 mb-8">ELO rankings for the AI Prompt Arena.</p>
      ...
      {loading ? (
        ...
        <div className="border border-zinc-800 rounded-lg overflow-hidden">
          <Table>
            ...
            <TableBody>
              {entries.map((entry) => (
                <TableRow key={entry.userId} className="border-zinc-800 hover:bg-zinc-900/50">
                  ...
                  <TableCell className="text-right font-mono text-zinc-100">{entry.elo}</TableCell>
