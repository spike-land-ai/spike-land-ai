        ...
        <DialogHeader>
          <div className="flex items-start gap-3 pr-8">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-zinc-500 mt-0.5 mb-2">{tool.displayName}</p>
          ...
          {tool.description && (
            <p className="text-sm text-zinc-400 mt-3 leading-relaxed">{tool.description}</p>
          )}
        </DialogHeader>

        <div className="space-y-4 mt-2">
          <McpToolForm tool={tool} onSubmit={handleExecute} isExecuting={state.isExecuting} />
          <McpResponseViewer
