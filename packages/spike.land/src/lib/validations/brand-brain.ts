...
export const COLOR_USAGES = ["primary", "secondary", "accent", "background", "text"] as const;
...
export const visualIdentitySchema = z.object({
  ...
  colorPalette: z.array(colorPaletteItemSchema).max(10, "Maximum 10 colors allowed").optional(),
});
