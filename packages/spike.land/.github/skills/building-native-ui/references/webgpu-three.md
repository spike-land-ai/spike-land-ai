...
**Use this skill for ANY 3D graphics, games, GPU compute, or Three.js features
in React Native.**
...
**Critical:** These versions are tested together. Mismatched versions cause type
...
**Note:** `--legacy-peer-deps` may be required due to peer dependency conflicts
with canary Expo versions.
...
**Solution:** Add the missing component to the `extend()` call in
fiber-canvas.tsx:
