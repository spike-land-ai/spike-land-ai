...
> **New Architecture Only**: CSS gradients require React Native's New
> Architecture (Fabric). They are not available in the old architecture or Expo
> Go.
...
- Direction keywords: `to top`, `to bottom`, `to left`, `to right`,
  `to top left`, etc.
